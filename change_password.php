                ...
                <div class="col-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-2">Please update your information</h1>
                            <p class="mb-4">If you can't access the system and are redirected here, it's because every 45 days the system requires you to update your information for security reasons. Thank you for understanding.</p>
                            <?php
                                if (!empty($_POST["actualizar"])) {
                                    ...
                                    if ($ciclo_actual<3) {
                                        ...
                                        if (in_array($contrasenaNew, $contrasenas_anteriores)) {
                                            echo "<div class='alert alert-danger'>The new password cannot be the same as a previous password.</div>";
                                        } else {
                                            ...
                                            echo "<div class='alert alert-success'>Data successfully updated. Redirecting in 3 seconds...</div>";
                        ...
                        <form class="user" action="" method="POST">
                            <div class="form-group">
                                <input type="text" name="usernew" class="form-control form-control-user mb-3" id="usernew" placeholder="New Username">
                                <input type="password" name="passnew" class="form-control form-control-user mb-3" id="passnew" placeholder="New Password">
                            </div>
                            <input type="submit" name="actualizar" class="btn btn-primary btn-user btn-block" value="Update"></input>
                        </form>
                    </div>
                </div>
            </div>
